...
# Create a new user named "fivem" without a password
sudo adduser --disabled-password --gecos "" fivem

# Add the user to the sudo group for administrative permissions
...
# =============================================================================
# HEBERGTONSERV.COM
# FIVEM SERVER DEPENDENCIES INSTALLATION
# Simple version - Just the dependencies
# =============================================================================
set -e
# Colors
RED='\033[0;31m'
